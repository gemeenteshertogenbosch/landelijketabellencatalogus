...
$ helm install ./api/helm --name tabellen --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade tabellen  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del tabellen  --purge --kubeconfig="api/helm/kubeconfig.yaml" 
